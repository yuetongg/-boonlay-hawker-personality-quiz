      ...
      <div className="space-y-8 text-center">
        ...
        <div className="space-y-3 max-w-md mx-auto">
          <p className="text-lg text-gray-700">
            Wander through Boonlay Hawker Village and discover your personality through the lens of its most iconic dishes.
          </p>
          <p className="text-sm text-gray-600">
            Answer 10 questions to find out which hawker dish matches your personality.
          </p>
        </div>
